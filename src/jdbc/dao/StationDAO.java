	...
	public void update() {
		try {
			...
			try {
				...
				CsvReader stations = new CsvReader("/Users/Filipe/Dropbox/Workspace/Maquinarus/Projects/London Underground/data/stations.csv");
				...
				while (stations.readRecord()) {
					...
					station.setLatitude(Float.parseFloat(stations.get("latitude")));
					station.setLongitude(Float.parseFloat(stations.get("longitude")));
					...
					station.setTotalLines(Integer.parseInt(stations.get("total_lines")));
